      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          <button
            ...
            className="w-full py-2.5 px-3.5 rounded-2xl bg-indigo-600 hover:bg-indigo-500 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md shadow-indigo-200 transition"
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-2 px-2.5 rounded-xl bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold text-[11px] flex items-center justify-center gap-1.5 border border-indigo-100 transition"
            >
            ...
            <button
              ...
              className="py-2 px-2.5 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-700 font-bold text-[11px] flex items-center justify-center gap-1.5 border border-slate-200 transition"
            >
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between px-3.5 py-2.5 rounded-2xl text-xs font-bold transition ${
                  isActive
                    ...
                    : item.highlight
                    ? 'text-indigo-700 bg-gradient-to-r from-amber-50 to-indigo-50 hover:from-amber-100 hover:to-indigo-100 border border-amber-200/80'
              ...
              >
                ...
                {item.highlight && !isPro && (
                  <span className="text-[9px] font-extrabold uppercase px-1.5 py-0.5 rounded-full bg-amber-400 text-slate-950 shadow-2xs">
                    7-Day Trial
                  </span>
                )}
